...
def create_gradio_interface():
    ...
    with gr.Blocks(
        title="Enterprise Knowledge Base - RAG Chat",
        theme=gr.themes.Soft(),
    ) as interface:
        gr.Markdown(
            """
            # 🔬 Enterprise Knowledge Base - RAG Chat
            
            Ask questions about documents in your enterprise knowledge base.
            The system will search through indexed documents and provide answers with sources.
            """
        )
            ...
            with gr.Column():
                with gr.Accordion("Advanced Options", open=False):
                    ...
                    categories = gr.Textbox(
                        label="Document Categories (optional)",
...
def main():
    ...
    print("🚀 Starting Enterprise Knowledge Base Gradio Interface...")
