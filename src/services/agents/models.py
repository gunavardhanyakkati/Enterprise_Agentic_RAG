...
class DocumentSourceItem(BaseModel):
    ...
    :param external_id: External document ID
    :param title: Document title
    :param contributors: List of contributors/authors
    :param source_url: Link to the original document
    :param source_type: Type of the source (e.g., 'arxiv', 'confluence')
    :param relevance_score: Relevance score from retrieval
    """

    external_id: Optional[str] = Field(None, description="External document ID")
    title: str = Field(..., description="Document title")
    contributors: List[str] = Field(default_factory=list, description="List of contributors/authors")
    source_url: str = Field(..., description="Link to original document")
    source_type: str = Field(..., description="Type of the source (e.g., 'arxiv', 'confluence')")
