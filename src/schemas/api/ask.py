...
class AskRequest(BaseModel):
    ...
    categories: Optional[List[str]] = Field(None, description="Filter by document categories/tags")
    department: Optional[str] = Field(None, description="Filter by department/division")

    class Config:
        json_schema_extra = {
            "example": {
                "query": "What are the Q4 financial results?",
                "top_k": 3,
                "use_hybrid": True,
                "model": "llama3.2:1b",
                "categories": ["financial", "quarterly"],
                "department": "finance",
            }
        }
...
class AskResponse(BaseModel):
    ...
    sources: List[str] = Field(..., description="PDF URLs of source documents")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "sources": ["https://company.com/docs/q4_report.pdf"],
                "chunks_used": 3,
                "search_mode": "hybrid",
            }
        }
